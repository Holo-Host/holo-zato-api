...
class HoloKVStoreListKeys(Service):
    ...
    def handle(self):
        ...
        # params
        params = {"account":account, "namespace":namespace}

        # Obtains a connection object
        conn = self.outgoing.plain_http['cloudflare-kvstore-list-keys'].conn
...
outconn:cloudflare-kvstore-list-keys:
    https://api.cloudflare.com
    /client/v4/accounts/{account}/storage/kv/namespaces/{namespace}/keys
    Cloudflare API
